...
Truemail.configure do |config|
  ...
  config.verifier_email = 'hello@postcard.page'
  ...
  config.verifier_domain = 'postcard.page'
  ...
  config.whitelisted_domains = %w[gmail.com yahoo.com example.com]
  ...
  # It is equal to empty array by default.
  config.blacklisted_domains = %w[mail.ru yandex.ru vk.com]
